...
{
    Chess::Bishop blackBishop(1, Chess::Color::Black, 1, 2);

    ASSERT_EQ(1, blackBishop.getId());
    ASSERT_EQ("B", blackBishop.getClassId());
    ASSERT_EQ(Chess::Color::Black, blackBishop.getColor());
...
{
    Chess::King blackKing(1, Chess::Color::Black, 1, 2);

    ASSERT_EQ(1, blackKing.getId());
    ASSERT_EQ("K", blackKing.getClassId());
    ASSERT_EQ(Chess::Color::Black, blackKing.getColor());
...
{
    Chess::Knight blackKnight(1, Chess::Color::Black, 1, 2);

    ASSERT_EQ(1, blackKnight.getId());
    ASSERT_EQ("N", blackKnight.getClassId());
    ASSERT_EQ(Chess::Color::Black, blackKnight.getColor());
...
{
    Chess::Pawn blackPawn(1, Chess::Color::Black, 1, 2);

    ASSERT_EQ(1, blackPawn.getId());
    ASSERT_EQ("P", blackPawn.getClassId());
    ASSERT_EQ(Chess::Color::Black, blackPawn.getColor());
...
{
    Chess::Queen blackQueen(1, Chess::Color::Black, 1, 2);

    ASSERT_EQ(1, blackQueen.getId());
    ASSERT_EQ("Q", blackQueen.getClassId());
    ASSERT_EQ(Chess::Color::Black, blackQueen.getColor());
...
{
    Chess::Rook blackRook(1, Chess::Color::Black, 1, 2);

    ASSERT_EQ(1, blackRook.getId());
    ASSERT_EQ("R", blackRook.getClassId());
    ASSERT_EQ(Chess::Color::Black, blackRook.getColor());
